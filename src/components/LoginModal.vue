<template>
    ...
    <div class="absolute inset-0">
      <div class="flex h-full">
        <div class="z-30 m-auto bg-white rounded shadow w-1/3"> 
        <div class="p-2 border">
          ...
          <form class="p-2 my-2" @submit.prevent="submit">
            <div class="my-4">
              ...
              <input ref="loginText" v-model="email" class="rounded shadow p-2 w-full" placeholder="Enter your email or username">
            </div>
            <div class="my-4">
